...
public class FareDinleyici implements java.awt.event.MouseListener, MouseMotionListener {

	private Game game;

	public FareDinleyici(Game game) {
		this.game = game;
	}
	...
	public void mouseDragged(MouseEvent e) { 
		...
		case Oynaniyor:
			...
			break;
		case DUZENLE:
			game.getDuzenleme().mouseDragged(e.getX(), e.getY());
			break;
		default:
			break;
		}
	...
	public void mouseMoved(MouseEvent e) { 
		...
		case Oynaniyor:
			...
			break;
		case DUZENLE:
			game.getDuzenleme().mouseMoved(e.getX(), e.getY());
			break;
		case OYUN_BITTI:
	...
	public void mouseClicked(MouseEvent e) {
		if (e.getButton() == MouseEvent.BUTTON1) {
			...
			case Oynaniyor:
				...
				break;
			case DUZENLE:
				game.getDuzenleme().mouseClicked(e.getX(), e.getY());
				break;
			case OYUN_BITTI:
	...
	public void mousePressed(MouseEvent e) {
		...
		case Oynaniyor:
			...
			break;
		case DUZENLE:
			game.getDuzenleme().mousePressed(e.getX(), e.getY());
			break;
		case OYUN_BITTI:
   ...
   @Override
	public void mouseReleased(MouseEvent e) {
		...
		case Oynaniyor:
			...
			break;
		case DUZENLE:
			game.getDuzenleme().mouseReleased(e.getX(), e.getY());
			break;
		case OYUN_BITTI:
